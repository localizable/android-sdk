...
public class LocalizableFallbackPtBrToPtTest extends LocalizableBaseAndroidTest {


  @Override
  public void setup() {
    super.setup();
    NetworkMocker.addResponseForOperation("supported_languages_default_pt",
        LocalizableOperation.languageCodes("token"), testApplicationContext());

    NetworkMocker.addResponseForOperation("pt",
        LocalizableOperation.updateLanguage("pt", 0, "token"), testApplicationContext());
  }

  @Test
  public void checkLocalizableStringsGetString() throws InterruptedException {
    Localizable.setLocale(new Locale("pt", "BR"));
    assertThat(Localizable.getString(R.string.string1), equalTo("pt"));
  }
}
